...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2019 at 06:27 PM
...
INSERT INTO `ca_users` (`id`, `email`, `first_name`, `last_name`, `password`, `validation_code`, `active`, `phone`, `college`, `anweshaid`, `qrcode`, `date`, `gender`, `candidates`, `points`) VALUES
(2, 'hayyoulistentome@gmail.com', 'Amartya', 'Mondal', '21b8acfc474802e2e0bd25a85f5e924e', '6378e0140437eae0cea61070f8b9303d', 1, '8967570983', 'IIT Patna', 'CLST1504', 'http://localhost:8888/Celesta2k19-Webpage/backend/user/assets/qrcodes/CLST5652.png', '2019-08-24 13:06:35', 'm', NULL, NULL),
(3, '8967570983@gmail.com', 'Amartya', 'Mondal', '21b8acfc474802e2e0bd25a85f5e924e', '13bff630177d1e119024ea72339203b6', 1, '8967570983', 'IIT Patna', 'CLST5523', 'http://localhost:8888/Celesta2k19-Webpage/backend/user/assets/qrcodes/CLST5523.png', '2019-09-01 13:17:06', 'm', NULL, NULL),
(4, 'pranaykgupta21@gmail.com', 'Pranay', 'Gupta', '81dc9bdb52d04dc20036dbd8313ed055', '0', 1, '09354008441', 'IIT Patna', 'ANW7872', 'https://anwesha.info/backend/user/assets/qrcodes/ANW7872.png', '2019-10-09 12:00:15', 'm', NULL, 100),
(5, 'sweetshwetagupta1996@gmail.com', 'Shweta', 'Gupta', '202cb962ac59075b964b07152d234b70', '72e9ecd3b7c107909fb9af89d873a3c4', 1, '9354008441', 'IIT Patna', 'ANW9856', 'https://anwesha.info/backend/user/assets/qrcodes/ANW9856.png', '2019-10-09 12:20:34', 'f', NULL, 100),
(6, 'pranaykgupta21@outlook.com', 'Pranay', 'Gupta', '81dc9bdb52d04dc20036dbd8313ed055', '0', 1, '09354008441', 'IIT Patna', 'ANW4222', 'https://anwesha.info/backend/user/assets/qrcodes/ANW4222.png', '2019-10-09 15:49:03', 'm', NULL, 100),
(7, '1801cs38@iitp.ac.in', 'Ponu', 'Gupta', '81dc9bdb52d04dc20036dbd8313ed055', '0', 1, '09354008441', 'IIT Patna', 'ANW2707', 'https://anwesha.info/backend/user/assets/qrcodes/ANW2707.png', '2019-10-09 18:24:19', 'm', NULL, 150);
...
CREATE TABLE `events` (
  ...
  `ev_registrations` longtext,
  `ev_participations` longtext,
...
CREATE TABLE `users` (
  ...
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `events_registered` longtext,
  `events_participated` longtext,
  `gender` varchar(1) NOT NULL,
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password`, `validation_code`, `active`, `phone`, `college`, `anweshaid`, `qrcode`, `added_by`, `ca_referral`, `date`, `events_registered`, `events_participated`, `gender`, `referral_id`, `access_token`, `registration_charge`, `total_charge`) VALUES
...
(129, 'Pranay', 'Gupta', 'pranaykgupta21@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '0', 1, '09354008441', 'IIT Patna', 'ANW7872', 'https://anwesha.info/backend/user/assets/qrcodes/ANW7872.png', 'admin', NULL, '2019-10-09 12:00:14', NULL, NULL, 'm', 'CLST1504', NULL, 0, 0),
(130, 'Shweta', 'Gupta', 'sweetshwetagupta1996@gmail.com', '202cb962ac59075b964b07152d234b70', '72e9ecd3b7c107909fb9af89d873a3c4', 0, '9354008441', 'IIT Patna', 'ANW9856', 'https://anwesha.info/backend/user/assets/qrcodes/ANW9856.png', 'admin', NULL, '2019-10-09 12:20:33', NULL, NULL, 'f', 'CLST1504', NULL, 0, 0),
(131, 'Pranay', 'Gupta', 'pranaykgupta21@outlook.com', '81dc9bdb52d04dc20036dbd8313ed055', '0', 1, '09354008441', 'IIT Patna', 'ANW4222', 'https://anwesha.info/backend/user/assets/qrcodes/ANW4222.png', 'admin', NULL, '2019-10-09 15:49:03', NULL, NULL, 'm', 'CLST1504', 'f48716795328491908e6097210f7af6f', 0, 0),
(132, 'Ponu', 'Gupta', '1801cs38@iitp.ac.in', '81dc9bdb52d04dc20036dbd8313ed055', '0', 1, '09354008441', 'IIT Patna', 'ANW2707', 'https://anwesha.info/backend/user/assets/qrcodes/ANW2707.png', 'admin', NULL, '2019-10-09 18:24:19', NULL, NULL, 'm', 'CLST1504', NULL, 0, 0);
...
ALTER TABLE `ca_users`
  ...
  ADD UNIQUE KEY `anweshaid` (`anweshaid`) USING BTREE;
